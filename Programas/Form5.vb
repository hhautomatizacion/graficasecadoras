Public Class Form5
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        For Each pPaso In cPasos
            ...
            y.Interval = 0
            y.IntervalOffset = pPaso.IdInicio
            y.StripWidth = pPaso.IdFin - pPaso.IdInicio
            y.BackGradientStyle = DataVisualization.Charting.GradientStyle.TopBottom
            If pPaso.Id Mod 2 Then
                y.BackColor = Drawing.ColorTranslator.FromOle(lColorPaso)
                y.BackSecondaryColor = Drawing.ColorTranslator.FromOle(lColorSecundarioPaso)
            Else
                y.BackColor = Drawing.ColorTranslator.FromOle(lColorPasoAlt)
                y.BackSecondaryColor = Drawing.ColorTranslator.FromOle(lColorSecundarioPasoAlt)
            End If
            y.Text = pPaso.Id
            y.TextAlignment = StringAlignment.Center
            y.TextOrientation = DataVisualization.Charting.TextOrientation.Horizontal
            y.ToolTip = "Paso:" & vbTab & pPaso.Id & vbCrLf & "Inicio:" & vbTab & pPaso.Inicio & vbCrLf & "Fin:" & vbTab & pPaso.Fin & vbCrLf & "Duracion:" & vbTab & pPaso.Duracion
    ...
    Private Sub Chart1_CursorPositionChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataVisualization.Charting.CursorEventArgs) Handles Chart1.CursorPositionChanged
        ...
        Else
            ...
            If iPosicion >= 0 And iPosicion <= Chart1.Series.Item(1).Points.Count - 1 Then
                ...
                sSQL = "SELECT id,fecha,secadora,temp1,temp2,formula,display,entrada1,entrada2,version FROM lecturas where secadora=" & ToolStripStatusLabel11.Tag & " and id=" & Chart1.Series.Item(1).Points.Item(iPosicion).Tag & ""
                mLector = Consulta(sSQL)
                Do While mLector.Read
